...
class PoseDetector {
  constructor(avatarCanvasRef, avatarSvgRef, outputCanvasRef, videoRef) {
    ...
    this.poseAnimator = new PoseAnimator(avatarCanvasRef, avatarSvgRef, this.videoWidth, this.videoHeight);
